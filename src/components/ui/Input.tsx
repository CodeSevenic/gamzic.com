    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          {leftIcon && (
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-dark-400">{leftIcon}</div>
          )}
          <input
            ref={ref}
            className={`
        ...
        {helperText && !error && <p className="mt-1.5 text-sm text-dark-400">{helperText}</p>}
      </div>
    );
  }
);
